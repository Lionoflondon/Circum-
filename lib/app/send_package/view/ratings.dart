...
bool ratingDeliveryReady(Map<String, dynamic> delivery) {
  ...
  return statuses.any(
        (value) => value == 'completed' || value == 'delivered',
      ) &&
      {
        'paid',
        'succeeded',
...
class DeliveryAppreciationService {
  ...
  Future<Map<String, dynamic>> submitTip({
    ...
    return ProductionPaymentApi.call('tips', 'submitDeliveryTip', {
      'deliveryId': deliveryId,
...
class _RatingsViewState extends State<RatingsView> {
        ...
        children: [
          ...
          if (data['rothAppliedAmount'] is num &&
            ...
            const Align(
              ...
              child: Text(
                'Any tip is separate from this delivery payment.',
  ...
  Widget _feedbackPanel() => Column(
    ...
    children: [
      const Text(
        'Optional feedback — shared with your Rider',
        style: TextStyle(
          color: Colors.white,
          fontWeight: FontWeight.w700,
          fontSize: 15,
          ...
          await Stripe.instance
              .initPaymentSheet(
                paymentSheetParameters: SetupPaymentSheetParameters(
                  ...
                  customerEphemeralKeySecret: _text(
            ...
            children: [
              ...
              Text(
                _stars == 0
                    ...
                    : _tags.any(
                        (tag) =>
                            tag == 'Safety concern' || tag == 'Damaged item',
                      )
