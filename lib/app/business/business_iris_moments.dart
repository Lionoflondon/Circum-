      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Wrap(spacing: 8, runSpacing: 8, children: [
          if (momentIsGiftOpportunity(moment)) ...[
            _Action('Open Gifts', Icons.card_giftcard_outlined, onSendGift),
        ...
        ...rows.map((row) => Container(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 10),
                    Wrap(spacing: 8, runSpacing: 8, children: [
                      _Action('Open Gifts', Icons.card_giftcard_outlined,
                          onSendGift),
                      _Action('Launch Delivery', Icons.local_shipping_outlined,
                          onCreateDelivery),
...
String momentRecommendedService(Map<String, dynamic> moment) {
  ...
  if (momentIsGiftOpportunity(moment)) {
    ...
    return 'Launch a $clean Gift request with Circum Gifts.';
  }
