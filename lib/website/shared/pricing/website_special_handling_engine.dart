import 'website_delivery_pricing.dart';
...
class SpecialHandlingResult {
  ...
  DeliveryPricingBreakdown applyTo(DeliveryPricingBreakdown base) {
    ...
    return DeliveryPricingBreakdown(
      ...
      heavyHandlingSurcharge: base.heavyHandlingSurcharge,
      twoPersonRecommended: base.twoPersonRecommended,
      twoPersonRequiredByWeight: base.twoPersonRequiredByWeight,
      multiTripReviewRequired: base.multiTripReviewRequired,
      heavyHandlingAdminReviewRequired: base.heavyHandlingAdminReviewRequired,
