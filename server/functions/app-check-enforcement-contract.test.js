...
test("financial and lifecycle mutation callables require App Check", () => {
  const expectations = [
    ...
    ["sender-booking.js", /createSenderPaidDelivery\s*=\s*\(stripe\) => functions\.runWith\(\{enforceAppCheck: true\}\)/],
    ...
    ["gifts-payment.js", /createGiftPayment\s*=\s*\(stripe\) => functions\.runWith\(\{enforceAppCheck: true\}\)/],
