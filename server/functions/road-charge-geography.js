...
const OFFICIAL_CCZ_POLYGONS = Object.freeze(
  CCZ_BOUNDARY.features
    .filter(
      (feature) =>
...
const CCZ_POLYGON = Object.freeze([
  [-0.106331, 51.531808],
  [-0.114031, 51.531288],
  [-0.115699, 51.529366],
  [-0.119614, 51.528552],
...
const CROSSINGS = Object.freeze([
  Object.freeze({
    ...
    southPortal: [-0.0085, 51.497],
    northPortal: [-0.0066, 51.5095],
    radiusMeters: 550,
  }),
  Object.freeze({
    chargeId: "blackwall_silvertown",
    crossingId: "silvertown",
    southPortal: [0.0058, 51.4992],
    northPortal: [0.0148, 51.5051],
    radiusMeters: 450,
  }),
  Object.freeze({
    chargeId: "dartford_crossing",
    crossingId: "dartford",
    southPortal: [0.2575, 51.464],
    northPortal: [0.2585, 51.486],
    radiusMeters: 850,
  }),
]);
...
const GEOGRAPHY_POLICY = Object.freeze({
  ...
  sourceUrl:
    "https://s3-eu-west-1.amazonaws.com/roads.data.tfl.gov.uk/boundaries/CC_Boundary_v8_20190526_tab_shape.zip",
...
function deriveCircumRouteFacts(
  points,
  {at = new Date(), googleTollSignal = null} = {},
) {
  if (
  ...
  for (const definition of CROSSINGS) {
    ...
    if (
      south.distance <= definition.radiusMeters &&
      north.distance <= definition.radiusMeters
    ) {
      crossings.push({
  ...
  return {
    ...
    corroboration: {
      googleReportedToll,
      disagreement:
        googleTollSignal != null && googleReportedToll !== circumDetectedCharge,
    },
  };
}
