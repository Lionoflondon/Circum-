...
exports.createStripeConnectAccountForRider = riderConnect.createStripeConnectAccountForRider(stripe);
exports.createStripeOnboardingLink = riderConnect.createStripeOnboardingLink(stripe);
exports.refreshStripeOnboardingLink = riderConnect.refreshStripeOnboardingLink(stripe);
exports.syncStripeConnectStatus = riderConnect.syncStripeConnectStatus(stripe);
exports.createRiderTransferOrPayout = riderConnect.createRiderTransferOrPayout(stripe);
exports.handleStripeConnectWebhook = riderConnect.handleStripeConnectWebhook(stripe);
