...
const IRIS_REPOSITORY_PATCH_FIELDS = [
  ...
  "knownWeightKg",
  "packagedWeightKg",
  "minimumPackagedWeightKg",
  "maximumPackagedWeightKg",
  "weightBasis",
  "weightEvidenceStatus",
  "weightVerificationId",
  "weightSourceReference",
  "modelIdentifier",
  "sku",
  "estimatedWeight",
  "irisEstimatedWeight",
  ...
  if (action === "promoted") {
    ...
    await db.runTransaction(async (transaction) => {
      ...
      transaction.set(canonicalRef, {
        ...
        knownWeightKg: latest.knownWeightKg || null,
        packagedWeightKg: latest.packagedWeightKg || null,
        minimumPackagedWeightKg: latest.minimumPackagedWeightKg || null,
        maximumPackagedWeightKg: latest.maximumPackagedWeightKg || null,
        weightBasis: latest.weightBasis || "generic_range",
        weightEvidenceStatus: latest.weightEvidenceStatus || "unverified",
        weightVerificationId: latest.weightVerificationId || null,
        weightSourceReference: latest.weightSourceReference || null,
        modelIdentifier: latest.modelIdentifier || null,
        sku: latest.sku || null,
