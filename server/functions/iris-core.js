...
const OBJECT_MAPPINGS = Object.freeze([
  // Common London courier and small-move items. Weights are conservative
  // packaged estimates; explicit or governed canonical weights can raise them.
  {
    id: "house_keys",
    patterns: [/\bhouse keys?\b/, /\bflat keys?\b/, /\boffice keys?\b/, /\bkey fobs?\b/],
  ...
  {
    id: "small_retail_parcel",
    patterns: [/\bshoe boxes?\b/, /\bsmall retail parcels?\b/, /\bonline returns?\b/],
  ...
  {
    id: "moving_box",
    patterns: [/\bmoving boxes?\b/, /\bremoval boxes?\b/, /\bboxes? of household items?\b/],
  ...
  {
    id: "laundry_bag",
    patterns: [/\blaundry bags?\b/, /\bdry cleaning\b/, /\bbags? of clothes\b/],
  ...
  {
    id: "bedding_bundle",
    patterns: [/\bbedding\b/, /\bduvets?\b/, /\bpillows? and bedding\b/, /\bbed linen\b/],
    category: "Furniture & Home",
    weightKg: 6,
    handlingFlags: ["Bulky"],
    vehicleRequired: "any",
  ...
  {
    id: "office_chair",
    patterns: [/\boffice chairs?\b/, /\bdesk chairs?\b/, /\bergonomic chairs?\b/],
    category: "Furniture & Home",
    weightKg: 15,
  ...
  {
    id: "office_desk",
    patterns: [/\boffice desks?\b/, /\bcomputer desks?\b/, /\bwriting desks?\b/],
    category: "Furniture & Home",
    weightKg: 30,
  ...
  },
  {
    ...
    patterns: [/\bflat[- ]?pack furniture\b/, /\bflat[- ]?packed shelves?\b/, /\bflat[- ]?packed table\b/],
    category: "Furniture & Home",
    weightKg: 25,
    handlingFlags: ["Bulky", "Awkward Shape", "Van Required"],
    vehicleRequired: "van",
  ...
  {
    id: "mirror",
    patterns: [/\bwall mirrors?\b/, /\bfull[- ]?length mirrors?\b/, /\bframed mirrors?\b/],
    category: "Fragile & Valuable",
    weightKg: 12,
    handlingFlags: ["Fragile", "Keep Upright", "Bulky"],
    vehicleRequired: "van",
  },
  {
    id: "floor_lamp",
    patterns: [/\bfloor lamps?\b/, /\btable lamps?\b/, /\blampshades?\b/],
    category: "Furniture & Home",
    weightKg: 5,
  ...
  {
    id: "rolled_rug",
    patterns: [/\brolled rugs?\b/, /\barea rugs?\b/, /\brolled carpets?\b/],
    category: "Furniture & Home",
    weightKg: 15,
    handlingFlags: ["Bulky", "Awkward Shape"],
    vehicleRequired: "van",
  ...
  {
    id: "vacuum_cleaner",
    patterns: [/\bvacuum cleaners?\b/, /\bhoovers?\b/],
    category: "Furniture & Home",
    weightKg: 8,
    handlingFlags: ["Bulky"],
    vehicleRequired: "any",
  ...
  {
    id: "air_fryer",
    patterns: [/\bair fryers?\b/, /\bmulticookers?\b/],
    category: "Furniture & Home",
    weightKg: 7,
  ...
  {
    id: "small_kitchen_appliance",
    patterns: [/\bkettles?\b/, /\btoasters?\b/, /\bfood processors?\b/, /\bblenders?\b/],
    category: "Furniture & Home",
    weightKg: 3,
  ...
  {
    id: "desktop_computer",
    patterns: [/\bdesktop computers?\b/, /\bgaming pcs?\b/, /\bcomputer towers?\b/],
  ...
  },
  {
    ...
    patterns: [/\bnetwork switches?\b/, /\brouters?\b/, /\bserver appliances?\b/, /\brack equipment\b/],
    category: "Business & Commercial",
    weightKg: 8,
  ...
  {
    id: "box_of_records",
    patterns: [/\bboxes? of vinyl records?\b/, /\brecord collections?\b/, /\bvinyl collections?\b/],
    category: "Personal Items & Luggage",
    weightKg: 14,
    handlingFlags: ["Fragile", "Keep Upright"],
    vehicleRequired: "any",
  ...
  {
    id: "camera_kit",
    patterns: [/\bcamera kits?\b/, /\bphotography kits?\b/, /\bcamera bags?\b/],
    category: "Fragile & Valuable",
    weightKg: 6,
    handlingFlags: ["Fragile", "High Value"],
    vehicleRequired: "any",
  ...
  {
    id: "lighting_kit",
    patterns: [/\bstudio lighting kits?\b/, /\bphotography lights?\b/, /\blight stands?\b/],
    category: "Business & Commercial",
    weightKg: 12,
  ...
  {
    id: "guitar",
    patterns: [/\bacoustic guitars?\b/, /\belectric guitars?\b/, /\bguitars? in cases?\b/],
    category: "Fragile & Valuable",
    weightKg: 7,
    handlingFlags: ["Fragile", "High Value", "Awkward Shape"],
    vehicleRequired: "any",
  },
  {
    id: "digital_keyboard",
    patterns: [/\bdigital keyboards?\b/, /\belectric pianos?\b/, /\bmidi keyboards?\b/],
    category: "Fragile & Valuable",
    weightKg: 15,
    handlingFlags: ["Fragile", "Awkward Shape"],
    vehicleRequired: "van",
  ...
  {
    id: "sports_kit_bag",
    patterns: [/\bsports kit bags?\b/, /\bfootball kits?\b/, /\bgym bags?\b/],
    category: "Personal Items & Luggage",
    weightKg: 6,
    handlingFlags: [],
    vehicleRequired: "any",
  ...
  {
    id: "golf_bag",
    patterns: [/\bgolf bags?\b/, /\bsets? of golf clubs?\b/],
    category: "Personal Items & Luggage",
    weightKg: 8,
    handlingFlags: ["Bulky", "Awkward Shape"],
    vehicleRequired: "van",
  ...
  {
    id: "catering_tray",
    patterns: [/\bcatering trays?\b/, /\boffice lunches?\b/, /\bfood platters?\b/],
  ...
  {
    id: "takeaway_order",
    patterns: [/\btakeaway orders?\b/, /\brestaurant orders?\b/, /\bmeal deliveries?\b/],
    category: "Food & Consumables",
    weightKg: 2,
    handlingFlags: ["Perishable", "Keep Upright"],
    vehicleRequired: "any",
  ...
  {
    id: "event_materials",
    patterns: [/\bevent materials?\b/, /\bconference packs?\b/, /\bexhibition materials?\b/],
    category: "Business & Commercial",
    weightKg: 10,
    handlingFlags: ["Bulky"],
    vehicleRequired: "any",
  },
  {
    ...
    patterns: [/\bboxes? of brochures?\b/, /\bprinted materials?\b/, /\bmarketing leaflets?\b/],
    category: "Business & Commercial",
    weightKg: 12,
    handlingFlags: [],
    vehicleRequired: "any",
  ...
  {
    id: "trade_paint_tin",
    patterns: [/\bpaint tins?\b/, /\bsealed paint cans?\b/],
  ...
  {
    id: "power_tool_case",
    patterns: [/\bpower tool cases?\b/, /\bdrill sets?\b/, /\btool cases?\b/],
    category: "Tools & Machinery",
    weightKg: 8,
    handlingFlags: ["High Value"],
    vehicleRequired: "any",
...
function classifyIris(input = {}) {
  ...
  const iris = {
    ...
    visualModelVersion: input.visualModelVersion || null,
