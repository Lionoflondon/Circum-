...
import 'package:circum/public_web/policy/public_gift_request_policy.dart';
...
import 'config/public_firebase_options.dart';
import 'shell/public_web_shell.dart';
...
class _PublicHeaderServicePills extends StatelessWidget {
  const _PublicHeaderServicePills({
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        _PublicHeaderServicePill(
          icon: Icons.local_shipping_outlined,
          label: 'Send a Parcel',
          accent: const Color(0xff38d7f0),
          colors: colors,
          onTap: onSend,
        ),
...
class _PublicHeaderServicePill extends StatelessWidget {
  const _PublicHeaderServicePill({
    required this.icon,
    required this.label,
        ...
        body: CircumWebShell(
          ...
          headerActions: !_authOpen && _route == CircumPublicRoute.landing
              ? _PublicHeaderServicePills(
                  colors: colors,
                  onSend: () => _openExternal(_canonicalSenderAppUrl),
                  onHealthPlus: () =>
                ...
                ConstrainedBox(
                  ...
                  child: Row(
                    children: [
                      ...
                      const SizedBox(width: 8),
                      Image.asset(
                        'assets/public/images/circum_wordmark.png',
                        width: 136,
                        height: 32,
                        fit: BoxFit.contain,
                      ),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        InkWell(
            ...
            child: Padding(
                ...
                child: Row(children: [
                  Image.asset('assets/public/images/circum_wordmark.png',
        ...
        child: ListView(
          ...
          children: [
            Row(children: [
              ...
              Image.asset('assets/public/images/circum_wordmark.png', width: 126),
            ]),
            const SizedBox(height: 22),
            Center(
              child: ConstrainedBox(
                ...
                child: Column(
                    ...
                    children: [
                      Center(
                          child: Image.asset(
                              'assets/public/images/gifts_by_circum_logo.jpg',
