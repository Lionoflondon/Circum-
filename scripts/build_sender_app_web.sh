...
WEB_GOOGLE_MAPS_DIRECTIONS_API_KEY="${GOOGLE_MAPS_DIRECTIONS_API_KEY:-}"
...
if [[ -z "$WEB_GOOGLE_MAPS_DIRECTIONS_API_KEY" ]]; then
  echo "Missing GOOGLE_MAPS_DIRECTIONS_API_KEY for Sender App Web route previews." >&2
  exit 1
fi
...
"$FLUTTER_BIN" build web \
  ...
  --dart-define=GOOGLE_MAPS_DIRECTIONS_API_KEY="$WEB_GOOGLE_MAPS_DIRECTIONS_API_KEY" \
