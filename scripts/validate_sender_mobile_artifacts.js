...
const usesStaticMapsCredential = read('scripts/build_public_web.sh')
  .includes('PUBLIC_WEB_STATIC_MAPS_API_KEY');
if (usesStaticMapsCredential) {
  ...
  assertContains('scripts/build_public_web.sh', 'GOOGLE_PLACES_API_KEY',
    'Legacy Public Web Places key validation during staged migration');
}
